                            ...
                            Circle()
                                ...
                                .overlay{
                                    Circle()
                                        ...
                                        .blur(radius: 4)
                                        .offset(x: 2, y: 2)
                                        .mask(Circle().fill(LinearGradient(gradient: Gradient(colors : [Color.clear, Color.black]), startPoint: .topLeading, endPoint: .bottomLeading)))
                                        .overlay{
                                            Circle()
    ...
    struct ContentView: View {
        ...
        var body: some View {
            ZStack{
                ...
                VStack{
                    HStack{
                        Text("Score: \(score)").padding(.horizontal, 5)
                        Spacer()}
